'''
count elements in a complete binary tree, 
...
def count_nodes(root):
    if root == None :
        return 0
    print('--visiting:',root.val,'left:',root.left,'right:',root.right )
    left_count = 0
    right_count = 0
    if root.left != None:
    ...
    if root.right != None:
        ...
        print( root.val,left_count,right_count, left_count+right_count+1 )
